...
//         if (!decodedData.transaction_code || !decodedData.status || !decodedData.total_amount || !decodedData.transaction_uuid || !decodedData.signature) {
...
//         const esewaUrl = `${process.env.ESEWA_GATEWAY_URL}/api/epay/transaction/status/?product_code=${process.env.ESEWA_PRODUCT_CODE}&total_amount=${decodedData.total_amount}&transaction_uuid=${decodedData.transaction_uuid}`;
...
//             console.error("Expected Amount:", decodedData.total_amount);
